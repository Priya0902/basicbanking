function Transfer() 
{
    ...
    var myaccount=parseInt(document.getElementById('PriyaBalance').innerText);
...
if(myaccount>transfer_Amount && transfer_Amount>200)
{
    ...
    let myaccount=parseInt(document.getElementById('PriyaBalance').innerText)-transfer_Amount;
    ...
    document.getElementById('PriyaBalance').innerText=myaccount;
    alert("Continue")
    document.getElementById('PriyaBalance').innerText=myaccount;
